...
(function() {
  ...
  const sampleNotices = [
    { id: 10, title: '🏆 Past Event Results — Announcement Coming Soon!', content: 'All TECHNOVA 2026 events — Hackathon 2026, Sports Meet 2026, and Cultural Night 2026 — have been successfully completed! 🎉 Results and winners will be announced very soon. Stay tuned for the official results, prizes, and e-certificates for all participants.', priority: 'urgent', date: '2026-05-16', author: 'VP Anvesh' },
    { id: 11, title: '🚀 5 New Upcoming Events Announced — Stay Tuned for Dates!', content: 'We are excited to announce 5 new upcoming events for TECHNOVA 2026! 🏗️ IoT Innovation Challenge — Build a working IoT prototype in 6 hours. 🎮 E-Sports Arena — Valorant, BGMI & Free Fire tournaments. 🧩 CypherChase (Treasure Hunt) — Campus-wide puzzle-solving adventure. 🧠 BrainBytes (Tech Quiz) — Electronics, programming & networking quiz. 💻 Code Blitz — Speed programming contest. Dates will be finalized soon and we will notify you!', priority: 'important', date: '2026-05-16', author: 'VP Anvesh' },
    { id: 1, title: 'TECHNOVA 2026 Registrations Open!', content: 'We are excited to announce that registrations for TECHNOVA 2026 are now open! Register for Hackathon, Sports Meet, Cultural Night and many more exciting events. Early bird registrations get exclusive merchandise.', priority: 'info', date: '2026-04-05', author: 'VP Anvesh' },
    { id: 2, title: 'Committee Applications — Last Date Extended', content: 'The last date for committee applications has been extended to April 10, 2026. All ECE students from SE, TE, and BE are eligible to apply for coordinator and volunteer positions. Apply through the official form.', priority: 'info', date: '2026-04-03', author: 'Technical Coordinator' },
    ...
    { id: 5, title: 'Cultural Night — Freshers Party, Farewell & Dinner Night', content: 'Cultural Night on May 12 will feature Freshers Party, Farewell and Dinner Night! Auditions for performances will be held from April 8-10 in the Main Auditorium. Solo, duet, and group entries are welcome in music, dance, drama, and fashion show categories.', priority: 'info', date: '2026-03-25', author: 'Cultural Coordinator' }
  ];
